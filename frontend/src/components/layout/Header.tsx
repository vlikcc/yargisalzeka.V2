...
export function Header({ className, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className={`h-16 glass border-b border-white/10 flex items-center px-4 lg:px-6 justify-between ${className || ''}`}>
      {/* Left side */}
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {/* Dropdown */}
        {showDropdown && (
          <div className="absolute right-0 top-full mt-2 w-56 glass rounded-xl py-2 z-50 animate-fade-in">
            ...
            <div className="py-1">
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm text-slate-300 hover:bg-white/5 hover:text-white flex items-center gap-2 transition-colors"
              >
